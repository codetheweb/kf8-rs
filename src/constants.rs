...
#[derive(Debug, PartialOrd, Ord, Eq, PartialEq, TryFromPrimitive, IntoPrimitive, Hash, Clone)]
#[cfg_attr(test, derive(Arbitrary))]
#[repr(u32)]
pub enum MetadataId {
    DrmServerId = 1,
...
#[derive(Debug, TryFromPrimitive, IntoPrimitive, PartialEq, Eq, PartialOrd, Ord, Clone, Hash)]
#[cfg_attr(test, derive(Arbitrary))]
